...
async def apply_loan(
    ...
    # If documents required, send notification email
...
async def upload_document(
    ...
    if loan_application_id:
        ...
        if loan and loan['status'] == 'requires_documents':
            ...
            # Send rejection email if rejected after document upload
            elif underwriting_result['status'] == 'rejected':
                email_subject = f"Loan Application Status - Tata Capital"
                email_body = f"""
                <html>
                <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
                    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                        ...
                        <p>Dear {current_user['full_name']},</p>
                        <p>Thank you for uploading your documents. After careful review, we regret to inform you that your application could not be approved at this time.</p>
                        
                        <div style="background-color: #FEF2F2; border-left: 4px solid #DC2626; padding: 15px; margin: 20px 0;">
                            <p><strong>Reason:</strong> {underwriting_result.get('message', 'Does not meet eligibility criteria')}</p>
                        </div>
